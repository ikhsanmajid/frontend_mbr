...
import TableLihatNomor from "./[id]/TableLihatNomor"
            ...
            <Modal show={show} onHide={onClose} size="xl" style={{ zIndex: 1050 }} backdrop="static" animation={true} keyboard={false}>
                ...
                <Modal.Body>
                    ...
                    >
                        ...
                        {!isLoadingListPengembalian && listPengembalian && listPengembalian.data.map((data: any, key: number) => (
                            <Tab key={key} eventKey={String(key)} title={`${data.nomorAwal} - ${data.nomorAkhir}`}>
                                {/* Header Information */}
