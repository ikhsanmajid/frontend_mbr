...
export default function ListPengembalianUser({ idProduk }: { idProduk: string }) {
    ...
    const { listPengembalian, isLoadingListPengembalian, error, mutateListPengembalian } = GetAllReturnRBByProductAndIdPermintaan(idProduk, idPermintaan, group_id, undefined, undefined, { status: statusKembali })
